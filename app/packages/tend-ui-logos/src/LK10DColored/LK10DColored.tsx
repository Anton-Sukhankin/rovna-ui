...
import { LK10D } from '../LK10D';
import { IconProps } from '../Icon';

const LK10DColored = React.forwardRef<HTMLSpanElement, Omit<IconProps, 'children'>>(
  ({ size = 24, ...props }, ref) => {
    ...
    return (
      <LogoWithBackground
        ...
        data-testid='rovna-ui-lk-10-d-colored-icon'
        {...props}
      >
        <LK10D size={iconSize} color='gray0' />
      </LogoWithBackground>
    );
  },
);

LK10DColored.displayName = 'LK10DColored';
