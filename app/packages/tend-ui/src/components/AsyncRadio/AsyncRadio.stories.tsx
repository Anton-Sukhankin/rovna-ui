...
import { Delete } from '@rovna-internal/components/icons';
...
const meta: Meta<typeof AsyncRadio> = {
  title: 'Rovna UI/Main/Components/AsyncRadio',
...
const RetryTemplate = (args: React.ComponentProps<typeof AsyncRadio>) => {
  const [key, setKey] = React.useState(0);

  return (
    <>
      <AsyncRadio {...args} key={key} />
...
<AsyncRadio scrollable={false} api='/api/example/' />
`;
