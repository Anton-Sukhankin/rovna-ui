...
describe('AsyncCheckbox', () => {
  ...
  describe('given "api" property is plaint url string', () => {
    ...
    it('requests data correctly', async () => {
      ...
      const renderer = render(<AsyncCheckbox api='http://localhost/api/animals/' />);
    ...
    describe('when data is loaded', () => {
      it('calls "onLoad" correctly', async () => {
        ...
        const renderer = render(
          <AsyncCheckbox api='http://localhost/api/animals/' onLoad={onLoadMock} />,
        );
  ...
  describe('given "api" as a function', () => {
    ...
    it('requests data correctly', async () => {
      ...
      const renderer = render(<AsyncCheckbox api={api} />);
    ...
    describe('when data is loaded', () => {
      it('executes "onLoad" callback with data correctly', async () => {
        ...
        render(<AsyncCheckbox api={api} onLoad={onLoadMock} />);
    ...
    describe('when some option has been selected and there is some search value', () => {
      it('does not request data again', async () => {
        ...
        const renderer = render(<AsyncCheckbox api={api} onSearch={onSearchMock} />);
    ...
    describe('when some value has been typed in order to search', () => {
      it('requests data correctly', async () => {
        ...
        const _renderer = render(<AsyncCheckbox api={api} />);

        expect(api).toHaveBeenCalledTimes(1);

        const input = screen.getByTestId('rovna-ui-input');
    ...
    describe('when "query" property has been changed', () => {
      it('requests data correctly', async () => {
        ...
        const renderer = render(<AsyncCheckbox api={{ fn: api }} />);

        expect(api).toHaveBeenCalledTimes(1);

        renderer.rerender(<AsyncCheckbox api={{ query: { contractor: 1 }, fn: api }} />);
