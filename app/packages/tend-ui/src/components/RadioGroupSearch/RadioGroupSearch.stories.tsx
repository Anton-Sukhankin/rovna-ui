...
const meta: Meta<typeof RadioGroupSearch> = {
  title: 'Rovna UI/Main/Components/RadioGroupSearch',
  component: RadioGroupSearch,
  args: {
...
<RadioGroupSearch scrollable={false} api='/api/example/' />
`;
