# Notifications Boundary Passport

Generated from the current R-09 catalog. Do not edit this file manually.

## Package And Import

- Package: `@rovna-ui/notifications`
- Coverage: `source-only-boundary`
- Import candidate: `@rovna-ui/notifications`
- Status: `source-only` / `mock required`

## Local Source

- `app/packages/tend-ui-notifications/src/Notifications.tsx`

## Use When

- Нужен documented provider/service boundary `Notifications`.
...
- Evidence: Experimental source-only приложение требует service mocks; автономные состояния относятся к R-02.
...
- `component-story-coverage:Notifications`
