...
- Storybook title: `Rovna UI/Hooks/useHover`
...
- `@rovna-ui/hooks/useHover`: direct-subpath; artifact path verified.

## Local Source

- `packages/tend-ui-hooks/src/useHover/useHover.stories.tsx`

## Use When

- Нужна React-механика `useHover` без самостоятельного визуального элемента.
...
- Stories: `1`.
- Docs: `1`.
- URL: http://127.0.0.1:3000/?path=/story/rovna-ui-hooks-usehover--default

## States

- `Default`: `rovna-ui-hooks-usehover--default`
...
- `component-story-coverage:useHover`
- `interaction-matrix:rovna-ui-hooks-usehover`
- `storybook:rovna-ui-hooks-usehover--default`
