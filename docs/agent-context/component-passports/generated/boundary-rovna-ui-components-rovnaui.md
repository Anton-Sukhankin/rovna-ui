...
- Import candidate: `@rovna-ui/components`
- Status: `provider contract` / `indirect Storybook/consumer evidence`

## Local Source

- `app/packages/tend-ui/src/theme/RovnaUI.tsx`
...
- Evidence: Compatibility provider проверяется всем Storybook runtime и тремя consumer routes.
