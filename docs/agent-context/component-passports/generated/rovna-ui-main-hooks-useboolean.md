...
- Storybook title: `Rovna UI/Main/Hooks/useBoolean`
- Package: `@rovna-ui/components`
- Contract: `direct-export`
- Status: `artifact verified` / `Storybook render verified` / `axe verified`

- `@rovna-ui/components/hooks`: preferred-barrel; artifact path verified.
- `@rovna-ui/components`: package-root; source-only candidate.

## Local Source

- `packages/tend-ui/src/hooks/useBoolean/useBoolean.stories.tsx`
...
- Stories: `1`.
- Docs: `1`.
- URL: http://127.0.0.1:3000/?path=/story/rovna-ui-main-hooks-useboolean--default

## States

- `Default`: `rovna-ui-main-hooks-useboolean--default`
...
- `interaction-matrix:rovna-ui-main-hooks-useboolean`
- `storybook:rovna-ui-main-hooks-useboolean--default`
