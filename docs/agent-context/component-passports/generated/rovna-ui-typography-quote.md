...
- Storybook title: `Rovna UI/Typography/Quote`
...
- `@rovna-ui/typography/Quote`: direct-subpath; artifact path verified.

## Local Source

- `packages/tend-ui-typography/src/Quote/Quote.stories.tsx`

## Use When

- Нужен компонент `Quote` из проверенной Storybook-группы `Rovna UI/Typography/Quote`.
...
- Stories: `1`.
- Docs: `1`.
- URL: http://127.0.0.1:3000/?path=/story/rovna-ui-typography-quote--default

## States

- `Default`: `rovna-ui-typography-quote--default`
...
- `component-story-coverage:Quote`
- `interaction-matrix:rovna-ui-typography-quote`
- `storybook:rovna-ui-typography-quote--default`
