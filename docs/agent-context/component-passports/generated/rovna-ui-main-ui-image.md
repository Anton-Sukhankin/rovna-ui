...
- Storybook title: `Rovna UI/Main/UI/Image`
...
- `@rovna-ui/components/ui/Image`: direct-subpath; artifact path verified.
- `@rovna-ui/components`: package-root; source-only candidate.

## Local Source

- `packages/tend-ui/src/ui/Image/Image.stories.tsx`

## Use When

- Нужен компонент `Image` из проверенной Storybook-группы `Rovna UI/Main/UI/Image`.
...
- Stories: `1`.
- Docs: `1`.
- URL: http://127.0.0.1:3000/?path=/story/rovna-ui-main-ui-image--default

## States

- `Default`: `rovna-ui-main-ui-image--default`
...
- `component-story-coverage:Image`
- `interaction-matrix:rovna-ui-main-ui-image`
- `storybook:rovna-ui-main-ui-image--default`
