...
- Storybook title: `Rovna UI/Main/UI/EmptyOverlay`
...
- `@rovna-ui/components/ui/EmptyOverlay`: direct-subpath; artifact path verified.
...
- Нужен компонент `EmptyOverlay` из проверенной Storybook-группы `Rovna UI/Main/UI/EmptyOverlay`.
...
- Stories: `2`.
- Docs: `0`.
- URL: http://127.0.0.1:3000/?path=/story/rovna-ui-main-ui-emptyoverlay--constrained

## States

- `Constrained`: `rovna-ui-main-ui-emptyoverlay--constrained`
- `Default`: `rovna-ui-main-ui-emptyoverlay--default`
...
- `component-story-coverage:EmptyOverlay`
- `interaction-matrix:rovna-ui-main-ui-emptyoverlay`
- `storybook:rovna-ui-main-ui-emptyoverlay--constrained`
- `storybook:rovna-ui-main-ui-emptyoverlay--default`
